...
1. ``FIG_DIR`` points at ``figures/si``.
...
discipline — is imported unchanged from ``figures_main.style``.
"""
...
from analysis.figures_main.style import *  # noqa: F401,F403
...
from analysis.figures_main.style import save_fig as _save_fig_main

FIG_DIR = ROOT / "figures" / "si"
DATA_DIR = ROOT / "analysis" / "figure_data" / "data"
