...
* b  the primary endpoint, terminal-lock score ``L``, seed by seed;
...
def _panels_bc(fig, rows, inf: dict) -> None:
    ...
    key.text(0.026, 0.28,
             "encoding mean $\\pm$ 95% CI over the six core seeds; the "
...
def _panel_h(fig, rows) -> None:
    ...
    fig_text_mm(fig, COL_L[1] - 0.5, H_TOP - 1.4, "terminal lock",
