...
def build(_out_dir: Path | None = None) -> Path:
    ...
    # conditions 1-2: the stimulus-domain campaign, same antipodal kappa = 6 family
    ...
    _para(fig, COL_X[2], C_NOTE_Y,
          "open = this campaign (tinted) · filled = stimulus-domain campaign; "
