"""Figs. 3-5 in the Science Advances house style, from the natcomm_figures_opus builders.

Run from the repository root:  python -m analysis.sciadv_revision.build_main_figures_v4
...
to figures/sciadv_v4 so the earlier exports stay untouched.

Changes relative to figures/natcomm_opus:
...
import analysis.natcomm_figures_opus.style as S  # noqa: E402
...
S.FIG_DIR = ROOT / "figures" / "sciadv_v4"
...
from analysis.natcomm_figures_opus import fig3_replay, fig4_cross_family, fig5_omap  # noqa: E402
