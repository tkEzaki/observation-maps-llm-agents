...
never anything that is not reproducible from `build_all`.
    ...
    py -m analysis.plot_supplement.cleanup_generated            # scratch only
    py -m analysis.plot_supplement.cleanup_generated --pages    # + built pages
    py -m analysis.plot_supplement.cleanup_generated --dry-run
"""
...
from analysis.plot_main.style import ROOT

FIG_DIRS = [
    ROOT / "figures" / "source_main",
    ROOT / "figures" / "plot_supplement",
]
...
def main(argv: list[str] | None = None) -> int:
    ...
    if a.dry_run:
        ...
        print("\nrebuild with: py -m analysis.plot_main.build_all"
              " && py -m analysis.plot_supplement.build_all")
    return 0
