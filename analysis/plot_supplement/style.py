...
1. ``FIG_DIR`` points at ``figures/plot_supplement``.
...
discipline — is imported unchanged from ``plot_main.style``.
"""
...
from analysis.plot_main.style import *  # noqa: F401,F403
...
from analysis.plot_main.style import save_fig as _save_fig_main

FIG_DIR = ROOT / "figures" / "plot_supplement"
DATA_DIR = ROOT / "analysis" / "figure_assets" / "data"
