...
OUT = ROOT / "analysis" / "natcomm_figures" / "data"
...
def export_prompts() -> None:
    ...
    # figures/natcomm and figures/natcomm_fable - carry that defect.
    #
    # The corrected selection is
    # analysis/natcomm_figures_opus/fig2_micro.py::_shared_field_records: it
    ...
    # index label. See analysis/natcomm_figures/DEPRECATED.md.
    #
    ...
    assert len(set(offsets.values())) == 1, (
        ...
        "analysis/natcomm_figures_opus/fig2_micro.py::_shared_field_records "
        "instead of regenerating data/prompt_excerpts_unimodal.json from this "
        "exporter (see analysis/natcomm_figures/DEPRECATED.md)."
    )
    excerpts = {}
