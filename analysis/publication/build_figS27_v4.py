...
Run from the repository root:  python -m analysis.publication.build_figS27_v4
...
and no in-figure title (the caption carries it). Output: figures/rendered_main.
"""
import numpy as np
import pandas as pd
import matplotlib
...
from analysis.publication.build_figures import REPS, NAMES
from analysis.publication.integrate_claude_figures import SOURCES, BLOCKS
from analysis.publication.build_figures_v4 import S, COLORS, panel_title, save, setup_v4
