"""publication figures, version 4: Fig. 1 and Fig. 2 in the shared journal style.

Same panels and data as version 3. Changes: Arial-metric type and STIX Sans maths
shared with Figs. 3-5 (analysis.plot_main.style), no text below 6 pt,
...
Run from the repository root:  python -m analysis.publication.build_figures_v4
...
from analysis.publication.build_figures import (ROOT, OUT, PAIRED, R2, REPS, NAMES,
    COLORS, setup, save, load, persistence, design_matrix)
from analysis.plot_main import style as S

OUT4 = ROOT/'figures/rendered_main'


def save(fig, name):
    """Write to figures/rendered_main so the version-3 exports stay untouched."""
