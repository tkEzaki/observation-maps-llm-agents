...
OUT = ROOT / "analysis" / "figure_assets" / "data"
...
def export_prompts() -> None:
    ...
    # figures/publication and figures/publication - carry that defect.
    #
    # The corrected selection is
    # analysis/plot_main/fig2_micro.py::_shared_field_records: it
    ...
    # index label. See analysis/figure_assets/DEPRECATED.md.
    #
    ...
    assert len(set(offsets.values())) == 1, (
        ...
        "analysis/plot_main/fig2_micro.py::_shared_field_records "
        "instead of regenerating data/prompt_excerpts_unimodal.json from this "
        "exporter (see analysis/figure_assets/DEPRECATED.md)."
    )
    excerpts = {}
