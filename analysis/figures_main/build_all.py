...
Usage:
  py -m analysis.figures_main.build_all [--only 1 2 ...]

Outputs to the earlier figure layout (PNG 450 dpi + vector PDF, true 180 mm width).
Reads the same source data as analysis.figure_data.
"""
...
from analysis.figures_main import (  # noqa: E402
    fig1_macro,
    fig2_micro,
    fig3_replay,
    fig4_cross_family,
...
from analysis.figures_main.style import FIG_DIR  # noqa: E402
...
same colours). Rebuild: `py -m analysis.figures_main.build_all`
